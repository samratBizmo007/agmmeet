...
//-----------function for add skill in db-----------//
    ...
    {
        extract($data);
        $sql = "INSERT INTO users_tab(member_name,availability,foodPreference,gender,mobile,timing,dated,ip_addr) VALUES ('$name','$availability','$foodPreference','$gender','$mobNumber','$time','$date','$ip_addr')";
